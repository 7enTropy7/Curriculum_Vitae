...
\begin{document}
	...
	\begin{flushleft}
	    \begin{itemize}
	    	\item \textbf{Microcontroller}$\,-\,$ Arduino, Raspberry Pi, 8051 Assembler, NVIDIA Jetson, FPGA
	        \item \textbf{Programming Languages}$\,-\,$Python, C++, C, Java, Go, Assembly, Verilog, CUDA MPI
